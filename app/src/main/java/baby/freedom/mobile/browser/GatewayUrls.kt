...
/**
 * Parses gateway-origin URLs (`http://127.0.0.1:1633/bzz/<hash>/…`,
 * `http://127.0.0.1:<ipfs>/ipfs/<cid>/…` etc.) into their
 * content-addressed components — used by the probe gate, which HEADs
 * the gateway base directly.
 *
